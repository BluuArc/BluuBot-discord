module.exports = {
  ...
  // Create an invite with these instructions:
  ...
  // i.e: "-bluubot foo" will trigger the command "foo",
  //      whereas "bluubot foo" will do nothing at all.
  // prefix:  "-bluubot",
  prefix: "|bb",
