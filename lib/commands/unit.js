    ...
    function print_embed(unit,flags){
        return new Promise(function(fulfill,reject){
            ...
            if(flags.print_art){
                ...
                var files = [
                    {filename:'unit_ills_thum_', name: "Elemental Thumbnail"},
                    {filename:'unit_ills_battle_', name: "Battle Thumbnail"},
                    {filename: 'unit_ills_full_', name: "Full Illustration"}];
                var urls = [];
            ...
            var url = common.getServerUrl(server);
