    ...
    fn: (argv, context) => {
        try {
            return new Promise(function (fulfill, reject) {
                ...
                //automatically set effects flag and special cases for embedding
                ...
                if(argv.flags.print_sp_skill.length > 0 && context.useEmbed){
                    argv.flags.print_sp = true;
                }
                if(!context.useEmbed && argv.flags.print_hitcounts){
                    argv.flags.print_raw_effects = true;
                }
