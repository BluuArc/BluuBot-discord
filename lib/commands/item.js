...
var command_flags = [
    ...
    {
        name: 'print_json',
        desc: 'Print the JSON data of an item. **WARNING:** this outputs a lot of text, so use carefully. I\'m not responsible for anything that happens using this in the wrong place',
        type: 'boolean',
        internal_type: "print",
        default: false
    },
