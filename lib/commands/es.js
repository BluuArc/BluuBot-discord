    ...
    function print_embed(es,flags){
        ...
        return new Promise(function(fulfill,reject){
            ...
            data_promise.then(function(){
                ...
                embed.fields.push({
                    name: "Buff Translation Note",
                    value: "Please note that buff translations are still a work in progress and as of June 26, 2017, passive buffs aren't supported yet"
                });
