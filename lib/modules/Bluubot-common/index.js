...
function common_library(){
    ...
    function create_sectional_messages(data_arr,msg_len,acc_limit){
        ...
        return Promise.resolve(msg_arr);
    }
    ...
    function getServerUrl(server){
        var servers = {
            "eu": "http://static-bravefrontier.gumi-europe.net/content/unit/img/",
            "gl": "http://2.cdn.bravefrontier.gumi.sg/content/unit/img/",
            "jp": "http://cdn.android.brave.a-lim.jp/unit/img/",
        };
